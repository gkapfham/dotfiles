    ...
    config = function()
      require("onedarkpro").setup({
        ...
        highlights = {
          ...
          CopilotChatDiffAdd = { fg = "${green}", bg = "${darkmenu}" },
          CopilotChatDiffDelete = { fg = "${red}", bg = "${darkmenu}" },
          CopilotChatDiffChange = { fg = "${blue}", bg = "${darkmenu}" },
          CodeCompanionChatInfoBanner = { fg = "${blue}" },
          CodeCompanionChatTool = { fg = "${green}" },
          CodeCompanionChatToolGroup = { fg = "${orange}" },
          CodeCompanionChatVariable = { fg = "${blue}" },
          ...
          -- DiffChange = { fg = "NONE" },
          -- DiffDelete = { fg = "NONE" },
          DiffAdd = { fg = "${green}", bg = "${darkmenu}" },
          DiffDelete = { fg = "${red}", bg = "${darkmenu}" },
          DiffChange = { fg = "${blue}", bg = "${darkmenu}" },
          ...
          LazyBackdrop = { fg = "${fg}", bg = "NONE" },
          LazyButton = { fg = "${fg}", bg = "NONE", bold = true },
          ...
          MiniDiffSignChange = { fg = "${blue}" },
          MiniDiffSignDelete = { fg = "${yellow}" },
          MiniDiffOverAdd = { fg = "${fg}" },
          Pmenu = { fg = "${fg}", bg = "${menu}" },
          PmenuSbar = { fg = "${black}", bg = "${black}" },
          PmenuSel = { fg = "${fg}", bg = "${highlight}" },
          PmenuThumb = { fg = "${fg}", bg = "${menu}" },
          NoiceCmdlinePopupBorder = { fg = "${highlight}", bg = "${bg}" },
          NoiceCmdlinePopupBorderSearch = { fg = "${highlight}", bg = "${bg}" },
          NoiceCmdlinePopupTitleCalculator = { fg = "${blue}", bg = "${bg}" },
          NoiceCmdlinePopupTitleCmdline = { fg = "${blue}", bg = "${bg}" },
          NoiceCmdlinePopupTitleSearch = { fg = "${yellow}", bg = "${bg}" },
          NoiceCmdlinePopupTitleHelp = { fg = "${blue}", bg = "${bg}" },
          ...
          SnacksBackdrop = { fg = "NONE", bg = "${bg}" },
          SnacksBackdrop_000000 = { fg = "NONE", bg = "${bg}" },
          SnacksPicker = { bg = "${bg}" },
          SnacksPickerTree = { fg = "${gray}" },
          SnacksGhNormalFloat = { fg = "${fg}", bg = "NONE" },
